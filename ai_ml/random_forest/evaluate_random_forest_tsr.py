#!/usr/bin/env python
"""Evaluate a saved Random Forest TSR classifier."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate a trained Random Forest TSR model.")
    parser.add_argument("--input_csv", required=True, help="CSV to evaluate.")
    parser.add_argument("--model_path", required=True, help="Path to random_forest_model.joblib.")

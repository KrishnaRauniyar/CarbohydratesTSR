#!/usr/bin/env python
"""Evaluate a saved Logistic Regression TSR classifier."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate a trained Logistic Regression TSR model.")
    parser.add_argument("--input_csv", required=True, help="CSV to evaluate.")
    parser.add_argument("--model_path", required=True, help="Path to logistic_regression_model.joblib.")

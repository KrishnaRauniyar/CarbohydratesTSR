#!/usr/bin/env python
"""Evaluate a saved SVM TSR classifier."""
...
from train_svm_tsr import predict_probability_like  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate a trained SVM TSR model.")
    parser.add_argument("--input_csv", required=True, help="CSV to evaluate.")
    parser.add_argument("--model_path", required=True, help="Path to svm_model.joblib.")
